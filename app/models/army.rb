class Army
  ...
  field :can_lift, type: Float, default: 0
  ...
  def recalculate_can_lift
    weigth_for_army = self.regiments.groups.pluck(:can_lift).inject(0, :+)
    self.update_attributes(:can_lift, weigth_for_army * self.race.strength / 100)
  end
end
